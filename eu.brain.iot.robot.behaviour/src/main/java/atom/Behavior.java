...
TEXT.setVal("NEW PICK POINT RESPONSE IS TRUE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
TEXT.setVal("HAS A NEW TASK ???"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
HASNEWTASK.setVal( Command.hasNewTask( REQ.getVal() , ROBOTID.getVal() ) );
...
_r=1;
 ...
 public int p7(){
 int _r=0;
 if(  S3.getVal( )==true  && p7.isAvailable() == false  && (HASNEWTASK.getVal() == 1 ) )
{
p7.setAvailable(true);  
}
 if( p7.isAvailable() ){
p7.setAvailable(false);
TEXT.setVal("HAS A NEW TASK IS TRUE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
...
_r=1;
 ...
 public int p8(){
 int _r=0;
 if(  S3.getVal( )==true  && p8.isAvailable() == false  && ( !(HASNEWTASK.getVal() == 1) ) )
{
p8.setAvailable(true);  
}
 if( p8.isAvailable() ){
p8.setAvailable(false);
TEXT.setVal("HAS A NEW TASK IS FALSE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
 Command.waitForTask( );
...
_r=1;
 ...
 public int p19(){
 int _r=0;
 if(  S11.getVal( )==true  && p19.isAvailable() == false  )
{
...
_r=1;
 ...
 @AtomMethodName(name="p22")  
 public int p22(){
 int _r=0;
 if(  S13.getVal( )==true  && p22.isAvailable() == false  && (MARKERID.getVal() == 1 ) )
{
p22.setAvailable(true);  
}
 if( p22.isAvailable() ){
p22.setAvailable(false);
TEXT.setVal(" HAS THE MARKER ID IS TRUE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
TEXT.setVal(" OPEN DOOR"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
DOORSTATE.setVal( Command.openDoor( REQ.getVal() , ROBOTID.getVal() ) );
...
_r=1;
 ...
 @AtomMethodName(name="p23")  
 public int p23(){
 int _r=0;
 if(  S14.getVal( )==true  && p23.isAvailable() == false  && (DOORSTATE.getVal() == 0 ) )
{
p23.setAvailable(true);  
}
 if( p23.isAvailable() ){
p23.setAvailable(false);
TEXT.setVal(" DOOR STATE IS FALSE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
TEXT.setVal(" RISING ALARM"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
 Command.finish( );
...
_r=1;
 ...
 public int p24(){
 int _r=0;
 if(  S14.getVal( )==true  && p24.isAvailable() == false  && (DOORSTATE.getVal() == 1 ) )
{
...
_r=1;
 ...
 @AtomMethodName(name="p34")  
 public int p34(){
 int _r=0;
 if(  S20.getVal( )==true  && p34.isAvailable() == false  && (MARKERID.getVal() == 1 ) )
{
p34.setAvailable(true);  
}
 if( p34.isAvailable() ){
p34.setAvailable(false);
TEXT.setVal(" HAS THE MARKER ID IS TRUE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
TEXT.setVal(" OPEN DOOR"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
...
_r=1;
 ...
 @AtomMethodName(name="p36")  
 public int p36(){
 int _r=0;
 if(  S21.getVal( )==true  && p36.isAvailable() == false  && (DOORSTATE.getVal() != 1 ) )
{
p36.setAvailable(true);  
}
 if( p36.isAvailable() ){
p36.setAvailable(false);
...
_r=1;
 ...
 @AtomMethodName(name="p37")  
 public int p37(){
 int _r=0;
 if(  S20.getVal( )==true  && p37.isAvailable() == false  && (MARKERID.getVal() != 1 ) )
{
p37.setAvailable(true);  
}
 if( p37.isAvailable() ){
p37.setAvailable(false);
TEXT.setVal(" GOTO DOCKING AREA"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
XDATA.setVal(4 );
RESPONSE.setVal( Command.sendGoto( ROBOTID.getVal() , XDATA.getVal() ) );
...
_r=1;
 ...
 @AtomMethodName(name="p38")  
 public int p38(){
 int _r=0;
 if(  S23.getVal( )==true  && p38.isAvailable() == false  && (RESPONSE.getVal() == 1 ) )
{
p38.setAvailable(true);  
}
 if( p38.isAvailable() ){
p38.setAvailable(false);
TEXT.setVal(" GOTO RESPONSE IS TRUE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
...
_r=1;
 ...
 @AtomMethodName(name="p40")  
 public int p40(){
 int _r=0;
 if(  S23.getVal( )==true  && p40.isAvailable() == false  && (RESPONSE.getVal() != 1 ) )
{
p40.setAvailable(true);  
}
 if( p40.isAvailable() ){
p40.setAvailable(false);
TEXT.setVal(" GOTO RESPONSE IS FALSE"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
TEXT.setVal(" RISING ALARM"  );
 Command.write( ROBOTID.getVal() , TEXT.getVal() );
